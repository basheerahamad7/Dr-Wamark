      ...
      <div className="space-y-12">
        ...
        <article className="prose prose-slate bg-white rounded-2xl p-6 md:p-8 border border-slate-200 shadow-sm">
          ...
          <div className="text-sm md:text-base text-slate-600 space-y-4 leading-relaxed">
            ...
            <p className="mt-4">
              Using a robust, localized text cleaner allows writers, software engineers, and researchers to completely sanitize their copy. Our <strong>Invisible Character &amp; Formatting Cleaner</strong> processes your input entirely in your browser. Since not a single character is transmitted to an external server, your sensitive documentation remains confidential.
            </p>
          </div>
        </article>
      </div>
